...
__DEFINE__(1750045634872, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1750045634873,"./event-store":1750045634874}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1750045634873, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1750045634874, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1750045634873,"./utils":1750045634875}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1750045634875, function(require, module, exports) {
...
return __REQUIRE__(1750045634872);
})()
